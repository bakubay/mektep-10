<template>
  <div class="flex">
    <div class="flex flex-col w-full min-h-full  py-2 my-4">
      ...
      <course-creator-form v-for="(section, index) of courseSections" :key="section.id" :index="index" @section-saved="saveSession" />
...
<script>
import CourseCreatorForm from "../createcourse/CourseCreatorForm.vue";
import { ref } from "vue";
export default {
  components: { CourseCreatorForm },
  setup() {
    let uuid = 1;
